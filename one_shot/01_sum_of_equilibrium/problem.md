- Given an array of integers, find an index such that the sum of elements at lower index is equal to the sum of elements at higher indexes. If no such index exists, return -1.
